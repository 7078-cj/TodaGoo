...
from .views import BookingView, BookingDetailView, user_bookings, driver_queue, driver_dequeue, driver_queue_status, RateView
urlpatterns = [
    ...
    path('rate/', RateView.as_view(), name='create-rate'),
]
