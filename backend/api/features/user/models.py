...
class Driver(models.Model):
    ...
    toda_boundary = models.ForeignKey(Toda, on_delete=models.PROTECT, related_name='toda_drivers', null=True, blank=True)
    toda_station = models.ForeignKey(TodaStation, on_delete=models.PROTECT, related_name='toda_station_drivers', null=True, blank=True)
